...
\label{sec:compare}
We compare along nine dimensions, summarized in Table~\ref{tab:compare}.
...
\begin{table*}[t]
\centering
\caption{Loop engineering vs.\ harness engineering across nine dimensions.}
\label{tab:compare}
\small
